...
const AGENCY_BRAND_LABEL = String(process.env.PLATFORM_DEFAULT_AGENCY_NAME ?? process.env.DEFAULT_AGENCY_NAME ?? 'Agencia de Tours').trim() || 'Agencia de Tours';
    ...
    <section className="relative overflow-hidden bg-[#f3f8f7] pb-16 text-slate-800 md:pb-24">
      ...
      <div className="relative h-[340px] overflow-hidden md:h-[440px]">
        ...
        <div className="absolute inset-x-0 bottom-0 mx-auto w-full max-w-6xl px-4 pb-8 text-white md:pb-12">
          <p className="text-xs font-extrabold uppercase tracking-[0.22em] text-cyan-100">{AGENCY_BRAND_LABEL}</p>
